            ...
            <Container fluid className={"login-form align-items-center p-0 py-5 d-flex minh-footer-adj "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={5} lg={4} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 bg-form opacity-9 border border-secondary p-4 rounded bg-form shadow text-secondary fw-bold z-index-10"
                            autoComplete="off"
                            method="POST">
                            ...
                            <Form.Group controlId="formLogin">
                                <Form.Label>Login</Form.Label>
                                 <Form.Control type="text" 
                                    ...
                                    className="rounded-pill border-secondary bg-white text-secondary"
                                    maxLength="50"
                                    name="userName"
